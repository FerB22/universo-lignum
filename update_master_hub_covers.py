    ...
    <div class="grid">
      ...
      <div class="card" style="--card-color: #FF4444;">
        <div>
          ...
          <p class="card-desc">Saga épica de 15 capítulos. Entre guerras tribales, pactos diplomáticos y el peso del liderazgo, guerreros y caudillos luchan por proteger a su pueblo y sobrevivir a la marea enemiga de Gricái.</p>
          <div class="card-features">
