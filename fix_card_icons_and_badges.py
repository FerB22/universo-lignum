...
<span style="font-size: 0.85rem; color: var(--text-muted); font-weight: normal; text-align: center;">Accede a la lectura de los 14 capítulos redactados.</span>
</a>'''
...
<span style="display:inline-block; font-size:0.72rem; font-weight:700; text-transform:uppercase; letter-spacing:1px; padding:0.2rem 0.55rem; border-radius:9999px; background:rgba(45,106,79,0.15); color:#2d6a4f; border:1px solid rgba(45,106,79,0.3);">Cuento Completo</span>
